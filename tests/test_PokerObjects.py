...
class Test_Card_Collection:
    ...
    class Test_gt:
        def test_HighCard_whenGreater(self):
        ...
        def test_differentLengths_raisesException(self):
    ...
    class Test_lt:
        def test_HighCard_whenSmaller(self):
    ...
    class Test_hasSameValuesAs:
        ...
        def test_differentLengths_raisesError(self):
