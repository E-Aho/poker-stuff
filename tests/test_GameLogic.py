...
class Test_find_strongest:
    ...
    def test_FullHouse_TripletAnd2Pairs_returnsCorrectly(self):
        king1 = Card(13, Suit.CLUBS)
        king2 = Card(13, Suit.HEARTS)
        king3 = Card(13, Suit.DIAMONDS)
    ...
    def test_FullHouse_TripletAndPair_returnsCorrectly(self):
    ...
    def test_FourOfAKind_withPair_returnsCorrectly(self):
    ...
    def test_FourOfAKind_baseCase_returnsCorrectly(self):
    ...
    def test_ThreeOfAKind_baseCase_returnsCorrectly(self):
    ...
    def test_TwoPair_baseCase_returnsCorrectly(self):
        seven1 = Card(7, Suit.CLUBS)
        seven2 = Card(7, Suit.HEARTS)
        ten1 = Card(10, Suit.CLUBS)
        ten2 = Card(10, Suit.SPADES)
    ...
    def test_TwoPair_threePairs_returnsCorrectly(self):
        seven1 = Card(7, Suit.CLUBS)
        seven2 = Card(7, Suit.HEARTS)
        ten1 = Card(10, Suit.CLUBS)
        ten2 = Card(10, Suit.SPADES)
    ...
    def test_Straight_baseCase_returnsCorrectly(self):
    ...
    def test_Straight_possibleSet_returnsCorrectly(self):
    ...
    def test_Straight_almostFlush_returnsCorrectly(self):
        seven = Card(7, Suit.SPADES)
        eight = Card(8, Suit.SPADES)
        nine = Card(9, Suit.SPADES)
        ten = Card(10, Suit.SPADES)
    ...
    def test_Flush_baseCase_returnsCorrectly(self):
        seven = Card(7, Suit.SPADES)
        eight = Card(8, Suit.SPADES)
        nine = Card(9, Suit.SPADES)
        ten = Card(10, Suit.SPADES)
    ...
    def test_Flush_possibleSet_returnsCorrectly(self):
        ace = Card(14, Suit.DIAMONDS)
    ...
    def test_Flush_possibleStraight_returnsCorrectly(self):
    ...
    def test_Flush_multiplePossible_returnsCorrectly(self):
        ace = Card(14, Suit.DIAMONDS)
        two = Card(2, Suit.DIAMONDS)
        queen = Card(12, Suit.DIAMONDS)
    ...
    def test_StraightFlush_baseCase_returnsCorrectly(self):
    ...
    def test_StraightFlush_multiplePossible_returnsCorrectly(self):
        three = Card(3, Suit.CLUBS)
        four = Card(4, Suit.CLUBS)
        five = Card(5, Suit.CLUBS)
        six = Card(6, Suit.CLUBS)
